            ...
            <div class="col-md-12">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <a class="btn btn-success btn-large" data-toggle="modal" data-href="#responsive" href="#responsive">New Permission</a>
                        ...
                        <table class="table table-striped table-responsive" id="table1">
                            ...
                            @foreach($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('delete_permission.id',['id'=>$permission->id])}}"> Delete</a>
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div class="modal fade in" id="responsive" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('new_permission')}}" method="post">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-md-offset-2">
                                ...
                                <p>
                                    ...
                                    <input id="name" name="name" type="text" placeholder="Permission Name" value="{{old('name')}}" class="form-control" required>
                                </p>
                                <p>
